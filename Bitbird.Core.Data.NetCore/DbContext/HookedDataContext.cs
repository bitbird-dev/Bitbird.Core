...
namespace Bitbird.Core.Data.DbContext
{
    ...
    /// 
    /// For more information about <see cref="Bitbird.Core.Data.DbContext"/> see the architecture of entity framework.
    /// </summary>
    /// <inheritdoc cref="Bitbird.Core.Data.DbContext" />
        ...
        where TDataContext : Microsoft.EntityFrameworkCore.DbContext
    {
        ...
        /// <param name="modelBuilder">The model builder that was passed to <see cref="OnModelCreating"/>.</param>
        [UsedImplicitly]
        public void ConfigureIOptimisticLockable<T>([NotNull] ModelBuilder modelBuilder) 
