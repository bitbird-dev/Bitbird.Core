...
namespace Bitbird.Core.JsonApi.Attributes
{
    ...
    public sealed class JsonApiDataCollectionAttribute : JsonContainerAttribute
    {
        ...
        /// </summary>
        public JsonApiDataCollectionAttribute()
        {
        }
        ...
        public JsonApiDataCollectionAttribute(bool allowNullItems)
        {
        ...
        public JsonApiDataCollectionAttribute(string id)
            : base(id)
        {
        }
    }
