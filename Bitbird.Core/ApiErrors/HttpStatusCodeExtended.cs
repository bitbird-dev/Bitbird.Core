...
namespace Bitbird.Core
{
    internal static class HttpStatusCodeExtended
    {
        ...
        [UsedImplicitly]
        internal const int Continue = 100;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int Created = 201;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int Accepted = 202;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int NonAuthoritativeInformation = 203;
        //
        // Summary:
        ...
        //     blank.
        [UsedImplicitly]
        internal const int NoContent = 204;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int ResetContent = 205;
        //
        // Summary:
        ...
        //     a byte range.
        [UsedImplicitly]
        internal const int PartialContent = 206;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int MultipleChoices = 300;
        //
        // Summary:
        ...
        //     header associated with this response.
        [UsedImplicitly]
        internal const int Ambiguous = 300;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int MovedPermanently = 301;
        //
        // Summary:
        ...
        //     redirected request will use the GET method.
        [UsedImplicitly]
        internal const int Redirect = 302;
        //
        // Summary:
        ...
        //     be made with a GET.
        [UsedImplicitly]
        internal const int SeeOther = 303;
        //
        // Summary:
        ...
        //     be made with a GET.
        [UsedImplicitly]
        internal const int RedirectMethod = 303;
        //
        // Summary:
        ...
        //     header.
        [UsedImplicitly]
        internal const int UseProxy = 305;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int TemporaryRedirect = 307;
        //
        // Summary:
        ...
        //     the redirected request will also use the POST method.
        [UsedImplicitly]
        internal const int RedirectKeepVerb = 307;
        //
        // Summary:
        ...
        //     for future use.
        [UsedImplicitly]
        internal const int PaymentRequired = 402;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int ProxyAuthenticationRequired = 407;
        //
        // Summary:
        ...
        //     the request.
        [UsedImplicitly]
        internal const int RequestTimeout = 408;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int LengthRequired = 411;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int RequestedRangeNotSatisfiable = 416;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int ExpectationFailed = 417;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int IAmATeapot = 418;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int UpgradeRequired = 426;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int NotImplemented = 501;
        //
        // Summary:
        ...
        [UsedImplicitly]
        internal const int BadGateway = 502;
        //
        // Summary:
